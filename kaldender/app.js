let VanillaCalendar = (function () {
    function VanillaCalendar(options) {
        ...
        const createDay = function (date) {
            ...
            newDayElem.setAttribute('data-calendar-date', date)          
             available_week_day = opts.availableWeekDays.filter(f => f.day === date.getDay() || f.day === getWeekDay(date.getDay()))
  ...
  let btnAvailableDates = document.querySelector('[name=pastDates]')
    ...
    let btnAvailableWeekDays = document.querySelector('[name=pastDates]')
